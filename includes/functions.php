...
function find_admin_by_id($admin_id) {
	...
	$query .= "LIMIT 1"; //get only one record 
...
function password_encrypt($password) {
    ...
    $salt_length = 22; //Blowfish salts should be 22-char or more. 

    $salt = generate_salt($salt_length); //make sure have 22 or more
    echo "Length: " . strlen($salt);
    $fotmat_and_salt = $hash_format . $salt;
    $hash = crypt ($password, $fotmat_and_salt);
